...
import (
	...
	"github.com/andyzhou/tackle/app/subApp/home"
	"github.com/andyzhou/tackle/app/subApp/video2gif"
...
func (f *MainEntry) Entry(
	...
	case define.WebReqAppOfVideo2gif:
		{
			//for video2gif
			dynamicPageContent, _ = f.video2gif.Entry(subApp, cookieInfo, playerId, ctx)
			break
		}
	default:
		{
			//for general page app
			dynamicPageContent, _ = f.home.Entry(subApp, cookieInfo, playerId, ctx)
		}
	}
